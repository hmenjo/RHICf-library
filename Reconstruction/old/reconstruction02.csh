...
set RUNINFOFILE="/mnt/lhcfs3/data5/RHICf_DATA1/RHICf_Op2017/quickanalysis_results/run${TMP}/runinfo_run${TMP}.dat"
set RUNDATAFILE="/mnt/lhcfs3/data5/RHICf_DATA1/RHICf_Op2017/quickanalysis_results/run${TMP}/rundata_run${TMP}.root"
...
$BINDIR/reconstruction02 -i $INPUTFILE -o $RECFILE -p $PEDEFILE -run RUN
#     -b -q 
