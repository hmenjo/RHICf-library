...
{ //make fit discri efficiency curve
  static const double fitparam0[2][16] = 
	 {{0.0520662, 0.0522364, 0.0521464, 0.581714, 0.0531239, 0.052079,  0.0528969, 0.0520054, 
		0.0527186, 0.0538613, 0.0532493, 0.053268, 0.0531763, 0.0538221, 0.0521287, 0.052582},
	  {0.0520774, 0.0493944, 0.0540197, 0.478771, 0.04742,   0.0497991, 0.0528811, 0.0501449, 
		0.0500626, 0.0514371, 0.0506653, 0.0504131,0.0513074, 0.0498368, 0.0509328, 0.0492228}};
  static const double fitparam1[2][16] = 
	 {{ 371.766, 330.089, 272.756, 104.722, 353.41,  282.97,  390.376, 433.254,
		 353.479, 361.112, 315.594, 354.829, 361.157, 343.286, 299.029, 405.443},
	  { 379.235, 359.076, 383.886, 106.749, 360.998, 401.6,   423.13,  431.784, 
		 334.176, 367.939, 358.987, 368.446, 409.109, 420.076, 376.832, 356.993}};
...
void RHICfFlag::SetFlag(A1Cal2 *a1cal2){
  ...
  for(int i=0; i<16; i++){
	 ...
	 //if(i == 15) cout << a1cal2->flag[0] << endl;
  ...
  for(int i=0; i<32; i++){
	 ...
	 //if(i == 31 ) cout << bitset<32>(a1cal2->flag[1]) << endl;
