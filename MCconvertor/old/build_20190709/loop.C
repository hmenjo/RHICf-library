void loop(){
  ...
  for(int i=71275; i<111176;i++){
    k = Form("%06d", i);
    //cout << "./convertor -i /ccj/w/data61/RHICf/DATA1/DATA1/satoken/simdata_510GeVpp/qgs/middle_20190619/20190619_SIMF_QGSJET2_MIDDLE_"<< k << ".root -o /ccj/w/r01/satoken/con_simdata/qgs/middle_rhicfv10fast/CONVERT_20190619_SIMF_QGSJET2_MIDDLE_" << k <<".root" << endl;
  }

  for(int i=124300; i<195002;i++){
    k = Form("%06d", i);
    cout << "./convertor -i /ccj/w/data61/RHICf/DATA1/DATA1/satoken/simdata_510GeVpp/qgs/middle_20190627/20190627_SIMF_QGSJET2_MIDDLE_"<< k << ".root -o /ccj/w/r01/satoken/con_simdata/qgs/middle_rhicfv10fast/CONVERT_20190627_SIMF_QGSJET2_MIDDLE_" << k <<".root" << endl;            
  }
