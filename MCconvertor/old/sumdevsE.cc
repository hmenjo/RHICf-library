...
int main(int argc, char** argv)
{
    ...
    TH1D* nrawspectrum   = new TH1D("nrawspectrum","Energy spectrum[raw];Neutron Energy[GeV];Event#",255,0.,255.);
    TH1D* nsignalspectrum   = new TH1D("nsignalspectrum","Energy spectrum[signal];Neutron Energy[GeV];Event#",255,0.,255.);
    TH1D* prawspectrum   = new TH1D("prawspectrum","Energy spectrum[raw];Gamma Energy[GeV];Event#",255,0.,255.);
    TH1D* psignalspectrum   = new TH1D("psignalspectrum","Energy spectrum[signal];Gamma Energy[GeV];Event#",255,0.,255.);
    TH1D* nrawpTdis   = new TH1D("nrawpTdistribution","pT distribution;pT[GeV/C];Event#",30,0.,1.2);
    TH1D* nsignalpTdis   = new TH1D("nsignalpTdistribution","pT distribution[signal];pT[GeV/C];Event#",30,0.,1.2);
    TH1D* prawpTdis   = new TH1D("prawpTdistribution","pT distribution;pT[GeV/C];Event#",30,0.,1.2);
    TH1D* psignalpTdis   = new TH1D("psignalpTdistribution","pT distribution[signal];pT[GeV/C];Event#",30,0.,1.2);
    ...
    TH1D* signallowEspec   = new TH1D("signallowpt","spectrum in low range;Neutron Energy[GeV];Event#",255,0.,255.);
    TH1D* signalhighEspec   = new TH1D("signalhighpt","spectrum in high range;Neutron Energy[GeV];Event#",255,0.,255.);
    TH2D* hitmap    = new TH2D("hitmap", "Hitmap;X[mm];Y[mm]", 200, -100, 100, 300, -150., 150.);
    TH2D* hitmap2    = new TH2D("hitmap2", "hitmap2;X[mm];Y[mm]", 200, -100, 100, 300, -150., 150.);
