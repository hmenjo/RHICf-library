#ifndef __A1PHYS_CPP__
#define __A1PHYS_CPP__
...
const int A1Phys::ALLPARTICLE;
const int A1Phys::ELEMAG;
const int A1Phys::HADRON;
const double A1Phys::cDistance = 141050.;
const double A1Phys::cPi0mass  = 0.1349766;

double A1Phys::sPositionBeamCenter[2] = {0.};
double A1Phys::sPositionBeamPipe[2]   = {0.};
...
bool A1Phys::InFiducial(int it,double edgecut){
...
double A1Phys::GlobalPos(int it,int ixy,double offsetx,double offsety){
...
double A1Phys::GetPi0Distance(bool check){
...
double A1Phys::GetPi0Mass(bool check){
...
double A1Phys::GetPi0Energy(bool check){
...
double A1Phys::Momentum(int it,int dir, double beamcenter_x,double beamcenter_y){
...
double A1Phys::GetPi0Momentum(int dir, double beamcenter_x, double beamcenter_y){
...
double A1Phys::GetPi0MomentumX(double beamcenter_x, double beamcenter_y){
  // = GetPi0Momentum(0,beamcenter_x, beamcenter_y);
  return GetPi0Momentum(0,beamcenter_x, beamcenter_y);
}

double A1Phys::GetPi0MomentumY(double beamcenter_x, double beamcenter_y){
  // = GetPi0Momentum(1,beamcenter_x, beamcenter_y);
  return GetPi0Momentum(1,beamcenter_x, beamcenter_y);
}

double A1Phys::GetPi0Pt(double beamcenter_x, double beamcenter_y){
...
double A1Phys::GetPi0Pl(double beamcenter_x, double beamcenter_y){
  // = GetPi0Momentum(2,beamcenter_x, beamcenter_y);
  return GetPi0Momentum(2, beamcenter_x, beamcenter_y);
}

double A1Phys::GetPi0Rapidity(double beamcenter_x, double beamcenter_y){
...
// *****************************************************************
int A1Phys::SetPositionBeamCenter(double x,double y){
  sPositionBeamCenter[0] = x;
  sPositionBeamCenter[1] = y;
  return 0;
}

int A1Phys::SetPositionBeamPipeCenter(double x,double y){
  sPositionBeamPipe[0] = x;
  sPositionBeamPipe[1] = y;
  return 0;
}

double A1Phys::GlobalPos_Detector(int tower, int ixy){
...
double A1Phys::GlobalPos_BC(int tower, int ixy, double offsetx,double offsety){
...
double A1Phys::GlobalPos_BeamPipe(int tower, int ixy, double offsetx,double offsety){
