#ifndef __A2RAW_PPB2016_CPP__
#define __A2RAW_PPB2016_CPP__
...
// A1Raw2_pPb2016
//
// Data Format for the operation at p-Pb collisions in 2016
// A2Raw_pPb2013 is original one. The difference is only 
// the data of adc3. 
...
//      [0]: Laser L      [1]: Laser R
//      [2]: Laser L (delayed gate)
//      [3]: Laser R (delayed gate)
//
...
//               by H.MENJO
//  12 Sep 2016: Copied A2Raw_pPb2013 to A2Raw_pPb2016.
//               Added adc3
//----------------------------------------------------------------------

#if !defined(__CINT__)
ClassImp(A2Raw_pPb2016);
#endif

// *****************************************************************
// ***  A2Raw_pPb2016  memory allocation of constant values.
// *****************************************************************
const int A2Raw_pPb2016::c_N_TIME ;
const int A2Raw_pPb2016::c_N_ADC0 ;
const int A2Raw_pPb2016::c_N_ADC1 ;
const int A2Raw_pPb2016::c_N_ADC2 ;
const int A2Raw_pPb2016::c_N_ADC3 ;
const int A2Raw_pPb2016::c_N_ADC4 ;
const int A2Raw_pPb2016::c_N_CAD0 ;
const int A2Raw_pPb2016::c_N_CAD1 ;
const int A2Raw_pPb2016::c_N_TDC0 ;
const int A2Raw_pPb2016::c_N_SCL0 ;
const int A2Raw_pPb2016::c_N_GPI0 ;
const int A2Raw_pPb2016::c_N_GPI1 ;
const int A2Raw_pPb2016::c_N_ARM2 ;

// ***********************************************************
// ***  A2Raw_pPb2016::clear     *****************************
// ***********************************************************
int A2Raw_pPb2016::clear(bankio option){
  ...
  // 
  // exp.  clear(A2Raw_pPb2016::ADC0 & A2Raw_pPb2016::ARM2);
...
// ***  A2Raw_pPb2016::copy      *****************************
// ***********************************************************
int A2Raw_pPb2016::copy(A2Raw_pPb2016* d,bankio option){
...
// ***********************************************************
// ***  A2Raw_pPb2016::copydata      *************************
// ***********************************************************
int A2Raw_pPb2016::copydata(A2Raw_pPb2016* d,bankio option){
...
// ***  A2Raw_pPb2016::add       *****************************
// ***********************************************************
int A2Raw_pPb2016::add(A2Raw_pPb2016* d,bankio option){
