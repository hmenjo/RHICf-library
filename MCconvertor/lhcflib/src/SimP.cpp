...
// Static valuables.
double SimP::sPositionBeamCenter[2] = {0.};
double SimP::sPositionBeamPipe[2]   = {0.};
...
double SimP::CalPosX(int id,int it,
		     double offsetx,
		     double offsety){
...
double SimP::CalPosY(int id,int it,
		     double offsetx,
		     double offsety){
  // CalPos(id,it,x,y,offsetx,offsety);
  // return y
...
int SimP::CheckHit(int id,int it,double edgecut,
		   double offsetx,
		   double offsety){
  ...
  // 
  // !! Warning !! 
  // The position of SimP is in the front of TAN ( in the front of Y-chember.)
...
double SimP::GetCalorimeterSize(int id,int it){
...
void SimP::Show(int id,int it,double offsetx,double offsety){
...
int SimP::SetPositionBeamCenter(double x,double y){
...
int SimP::SetPositionBeamPipeCenter(double x,double y){
...
double SimP::PositionShift(int ixy, double offsetx, double offsety){
  // Simple function which internally used. 
  return ixy==0? (PosX()+offsetx) : (PosY()+offsety);
}

double SimP::GlobalPos_Detector( int ixy, 
				 double offsetx,
				 double offsety){
...
double SimP::GlobalPos_BC(int ixy, 
			  double offsetx,
			  double offsety){
...
double SimP::GlobalPos_BeamPipe(int ixy){
