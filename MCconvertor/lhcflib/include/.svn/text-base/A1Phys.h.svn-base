...
// --------------------------------------------------------------------
//                               A1Phys
//             For detail, see A1Phys.cpp or Online Manual
// --------------------------------------------------------------------

#include <TNamed.h>
#include "globaldef.h"

class A1Phys : public TNamed {
 public:
  // event infomation
  int            run;       // Run number
 ...
 public:
  A1Phys(){clear();}
  A1Phys(char* name, char *title) : TNamed(name,title){clear();}
  ~A1Phys(){;}
  ...
  ClassDef(A1Phys,1);     // Data Structure for physics values of Arm1.
};
