...
class A2PhysAccumHist : public TNamed {
 public:
  ...
  TH1F*   hpid[2];      //->
  TH1F*   hhits[2];     //->
  TH1F*   hsideposit[2][4][2];//-> //Added by eugenio
  TH1F*   hsidepositsum[2];   //-> //Added by eugenio
 ...
 private: 
  ...
  static const int hsideposit_nbin = 100;
  static const int hsideposit_binmin = 0;
  static const int hsideposit_binmax =  25000;
  static const int hsidepositsum_nbin = 100;
  static const int hsidepositsum_binmin = 0;
  static const int hsidepositsum_binmax = 100000;
