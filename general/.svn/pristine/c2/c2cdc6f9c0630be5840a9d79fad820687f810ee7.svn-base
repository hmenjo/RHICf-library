#ifndef __A2RAW_PP2015_CPP__
#define __A2RAW_PP2015_CPP__
...
#if !defined(__CINT__)
ClassImp(A2Raw_pp2015);
#endif

// *****************************************************************
// ***  A2Raw_pp2015  memory allocation of constant values.
// *****************************************************************
const int A2Raw_pp2015::c_N_TIME ;
const int A2Raw_pp2015::c_N_ADC0 ;
const int A2Raw_pp2015::c_N_ADC1 ;
const int A2Raw_pp2015::c_N_ADC2 ;
const int A2Raw_pp2015::c_N_ADC3 ;
const int A2Raw_pp2015::c_N_ADC4 ;
const int A2Raw_pp2015::c_N_CAD0 ;
const int A2Raw_pp2015::c_N_CAD1 ;
const int A2Raw_pp2015::c_N_TDC0 ;
const int A2Raw_pp2015::c_N_SCL0 ;
const int A2Raw_pp2015::c_N_GPI0 ;
const int A2Raw_pp2015::c_N_GPI1 ;
const int A2Raw_pp2015::c_N_ARM2 ;

// ***********************************************************
// ***  A2Raw_pp2015::clear     *****************************
// ***********************************************************
int A2Raw_pp2015::clear(bankio option){
  ...
  // 
  // exp.  clear(A2Raw_pp2015::ADC0 & A2Raw_pp2015::ARM2);
...
// ***  A2Raw_pp2015::copy      *****************************
// ***********************************************************
int A2Raw_pp2015::copy(A2Raw_pp2015* d,bankio option){
...
// ***********************************************************
// ***  A2Raw_pp2015::copydata      *************************
// ***********************************************************
int A2Raw_pp2015::copydata(A2Raw_pp2015* d,bankio option){
...
// ***  A2Raw_pp2015::add       *****************************
// ***********************************************************
int A2Raw_pp2015::add(A2Raw_pp2015* d,bankio option){
