...
int ConShowerLeakage::ReadROOTFile(char* file,char* option){
  ...
  if(( strstr(option,"tin20")!=0 || strstr(option,"All")!=0)&&
     f->GetListOfKeys()->FindObject("h2fac20_leakin") !=0) {
    SetH2map20Leakin((TH2F*)f->Get("h2fac20_leakin"));
  }
  if(( strstr(option,"tin40")!=0 || strstr(option,"All")!=0)&&
     f->GetListOfKeys()->FindObject("h2fac40_leakin") !=0) {
