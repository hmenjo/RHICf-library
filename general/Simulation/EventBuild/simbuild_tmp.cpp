...
int main(int argc,char** argv){
  ...
  A1Cal2 *a2sim = new A1Cal2("a1sim2","Arm1 Simulation");
  SimIncidents* a2simin = new SimIncidents("a1simin2","Arm#1 Incident");
  a2sim->clear();
