...
class A1PedeSubtract {
 ...
 public:
  ...
  int     RHICfSubtract(A1Cal1* data, A1Cal1* pede=0);  // Subtraction including cal. of pedestal.
  int     Subtraction(A1Cal1* data);               // Only subtraction
  int     RHICfSubtraction(A1Cal1* data);               // Only subtraction
  int     Subtraction1(A1Cal1* data, int op=0);    // op : for internal use. 
  int     RHICfSubtraction1(A1Cal1* data, int op=0);    // op : for internal use. 
