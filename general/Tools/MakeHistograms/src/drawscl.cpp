...
int main(int argc,char **argv){
  ...
  RawL1T *a1rawl1tlast = NULL;
  SclL1T *a1scll1tlast = NULL;
  SclL1T *a2scll1tlast = NULL;
  
  a1callast = (A1Cal1*) file->Get("a1cal1last");
  a2callast = (A2Cal1*) file->Get("a2cal1last");
  a1rawl1tlast = (RawL1T*) file->Get("a1rawl1tlast");
  a1scll1tlast = (SclL1T*) file->Get("a1scll1tlast");
  ...
  if(a1scll1tlast){
    if(info){
      deltat = a1scll1tlast->time[0] - info->start_time;
    ...
    for(int i=0;i<20;i++){
      sprintf(tmp,"%8.1lf",(double)a1scll1tlast->bcounters[i]/deltat);
      texc->DrawTextNDC(x+offx*(i%10),y-offy*(i/10),tmp);
      h1->Fill(i+0.5,a1scll1tlast->bcounters[i]/deltat);
    }
  }
  ...
  if(a1rawl1tlast){
    ...
    ic++;
    texc->DrawTextNDC(x,y-offy*ic,"L1T_E/L1T");
    icounter1 = (int)a1rawl1tlast->gpio2[6];
    icounter2 = (int)a1rawl1tlast->gpio2[4];  
    texc->DrawTextNDC(x+offx*2.0,y-offy*ic,GetChar("%8d",icounter1));
    texc->DrawTextNDC(x+offx*3.1,y-offy*ic,"/");
    texc->DrawTextNDC(x+offx*3.2,y-offy*ic,GetChar("%8d",icounter2));
    texc->DrawTextNDC(x+offx*4.2,y-offy*ic,GetChar("%8.4lf",(double)(icounter1)/icounter2));
    ...
    icounter1 = (int)a1rawl1tlast->gpio2[11];
    icounter2 = (int)a1rawl1tlast->gpio2[10];  
    texc->DrawTextNDC(x+offx*2.0,y-offy*ic,GetChar("%8d",icounter1));
    texc->DrawTextNDC(x+offx*3.1,y-offy*ic,"/");
    texc->DrawTextNDC(x+offx*3.2,y-offy*ic,GetChar("%8d",icounter2));
    texc->DrawTextNDC(x+offx*4.2,y-offy*ic,GetChar("%8.4lf",(double)(icounter1)/icounter2));
  ...
  if(a1rawl1tlast){
    ...
    ic++;
    texc->DrawTextNDC(x,y-offy*ic,"L1T_E/L1T");
    icounter1 = (int)a1rawl1tlast->gpio2[7];
    icounter2 = (int)a1rawl1tlast->gpio2[5];  
    texc->DrawTextNDC(x+offx*2.0,y-offy*ic,GetChar("%8d",icounter1));
    texc->DrawTextNDC(x+offx*3.1,y-offy*ic,"/");
    texc->DrawTextNDC(x+offx*3.2,y-offy*ic,GetChar("%8d",icounter2));
    texc->DrawTextNDC(x+offx*4.2,y-offy*ic,GetChar("%8.4lf",(double)(icounter1)/icounter2));
    ic++; 
    texc->DrawTextNDC(x,y-offy*ic,"L2TA_E/L2TA");
    icounter1 = (int)a1rawl1tlast->gpio2[13];
    icounter2 = (int)a1rawl1tlast->gpio2[12];  
    texc->DrawTextNDC(x+offx*2.0,y-offy*ic,GetChar("%8d",icounter1));
    texc->DrawTextNDC(x+offx*3.1,y-offy*ic,"/");
    texc->DrawTextNDC(x+offx*3.2,y-offy*ic,GetChar("%8d",icounter2));
    texc->DrawTextNDC(x+offx*4.2,y-offy*ic,GetChar("%8.4lf",(double)(icounter1)/icounter2));
