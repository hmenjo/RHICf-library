...
int main(int argc,char **argv){  
  ...
  latex->DrawTextNDC(X+0.02,Y-offy*2, "L2TA");
  latex->DrawTextNDC(X+0.03,Y-offy*3, "L2TA_MB");
  latex->DrawTextNDC(X+0.03,Y-offy*4, "L2TA_SP");  
  latex->DrawTextNDC(X+0.02,Y-offy*5, "L2TP");
  ...
  latex->DrawTextNDC(X+0.12,Y-offy*2, GetChar("%7d",info->a1_nevent_L2TA));
  latex->DrawTextNDC(X+0.12,Y-offy*3, GetChar("%7d",info->a1_nevent_L2TA_MB));
  latex->DrawTextNDC(X+0.12,Y-offy*4, GetChar("%7d",info->a1_nevent_L2TA_SP)); 
  latex->DrawTextNDC(X+0.12,Y-offy*5, GetChar("%7d",info->a1_nevent_L2TP));  
  ...
  latex->DrawTextNDC(X+0.22,Y-offy*2, GetChar("%8.2lf",info->a1_nevent_L2TA/deltat));
  latex->DrawTextNDC(X+0.22,Y-offy*3, GetChar("%8.2lf",info->a1_nevent_L2TA_MB/deltat));
  latex->DrawTextNDC(X+0.22,Y-offy*4, GetChar("%8.2lf",info->a1_nevent_L2TA_SP/deltat)); 
  latex->DrawTextNDC(X+0.22,Y-offy*5, GetChar("%8.2lf",info->a1_nevent_L2TP/deltat));
  ...
  latex->DrawTextNDC(X+0.12,Y-offy*2, GetChar("%7d",info->a2_nevent_L2TA));
  latex->DrawTextNDC(X+0.12,Y-offy*3, GetChar("%7d",info->a2_nevent_L2TA_MB));
  latex->DrawTextNDC(X+0.12,Y-offy*4, GetChar("%7d",info->a2_nevent_L2TA_SP)); 
  latex->DrawTextNDC(X+0.12,Y-offy*5, GetChar("%7d",info->a2_nevent_L2TP));  
  ...
  latex->DrawTextNDC(X+0.22,Y-offy*2, GetChar("%8.2lf",info->a2_nevent_L2TA/deltat));
  latex->DrawTextNDC(X+0.22,Y-offy*3, GetChar("%8.2lf",info->a2_nevent_L2TA_MB/deltat));
  latex->DrawTextNDC(X+0.22,Y-offy*4, GetChar("%8.2lf",info->a2_nevent_L2TA_SP/deltat)); 
  latex->DrawTextNDC(X+0.22,Y-offy*5, GetChar("%8.2lf",info->a2_nevent_L2TP/deltat));
  ...
  latex->DrawTextNDC(X+0.02,Y-offy*2, "TRIGGER");
  ...
  latex->DrawTextNDC(X+0.12,Y-offy*1, (CutdownGPIOLoad(info->a1_GPIOLoad)).c_str());
  latex->DrawTextNDC(X+0.12,Y-offy*2, (CutdownGPIOSetup(info->a1_GPIOSetup)).c_str());
  ...
  latex->DrawTextNDC(X+0.12,Y-offy*1, (CutdownGPIOLoad(info->a2_GPIOLoad)).c_str());
  latex->DrawTextNDC(X+0.12,Y-offy*2, (CutdownGPIOSetup(info->a2_GPIOSetup)).c_str());
