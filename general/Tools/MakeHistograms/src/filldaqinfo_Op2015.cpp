...
#include <ReadDAQLog_Op2015.h>
#include <ReadRunData_Op2015.h>
using namespace std;
...
int main(int argc,char** argv){
  ...
  if(check==-2){ 
    ...
    strcpy(info->a1_LogicMode,  a1log.LogicMode);
    strcpy(info->a1_V1495Load,  a1log.V1495Logic);
    strcpy(info->a1_V1495Setup, a1log.V1495Setup);    
  ...
  if(check==-2){ 
    ...
    strcpy(info->a2_LogicMode,  a2log.LogicMode);
    strcpy(info->a2_V1495Load,  a2log.V1495Logic);
    strcpy(info->a2_V1495Setup, a2log.V1495Setup);    
